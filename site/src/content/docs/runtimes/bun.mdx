...
<CardGrid stagger>
  <Card title="Point-to-Point" icon="link" href="/topologies/point-to-point/">
    2 nodes, active-active. Simplest setup.
  </Card>
  <Card title="Full Mesh" icon="puzzle" href="/topologies/full-mesh/">
    3-7 nodes, all-to-all sync.
  </Card>
  <Card title="Dedicated Hub" icon="server" href="/topologies/hub/">
    8+ nodes. Go-only relay with Pebble KV.
  </Card>
  <Card title="Multi-Region" icon="external" href="/topologies/multi-region/">
